package com.loomans.digit.controller;
...
public class KeyboardController implements InputProcessor {
    ...
    public Vector2 touchStartLocation = new Vector2(0,0);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        mouseLocation.x = touchStartLocation.x = screenX;
        mouseLocation.y = touchStartLocation.y = screenY;
        return false;
    }
    @Override
